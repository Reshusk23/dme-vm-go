...
import (
	...
	"github.com/Reshusk23/dme-vm/arwen"
	"github.com/Reshusk23/dme-vm/wasmer"
)

// ReshuskEIImports creates a new wasmer.Imports populated with the ReshuskEI API methods
func ReshuskEIImports() (*wasmer.Imports, error) {
...
func getGasLeft(context unsafe.Pointer) int64 {
	...
	gasToUse := metering.GasSchedule().ReshuskAPICost.GetGasLeft
...
func getSCAddress(context unsafe.Pointer, resultOffset int32) {
	...
	if arwen.WithFault(err, context, runtime.ReshuskAPIErrorShouldFailExecution()) {
		return
	}

	gasToUse := metering.GasSchedule().ReshuskAPICost.GetSCAddress
	metering.UseGas(gasToUse)
}
...
func getOwnerAddress(context unsafe.Pointer, resultOffset int32) {
	...
	gasToUse := metering.GasSchedule().ReshuskAPICost.GetOwnerAddress
	metering.UseGas(gasToUse)
}
...
func getShardOfAddress(context unsafe.Pointer, addressOffset int32) int32 {
	...
	gasToUse := metering.GasSchedule().ReshuskAPICost.GetShardOfAddress
	metering.UseGas(gasToUse)
...
func isSmartContract(context unsafe.Pointer, addressOffset int32) int32 {
	...
	gasToUse := metering.GasSchedule().ReshuskAPICost.IsSmartContract
	metering.UseGas(gasToUse)
...
func signalError(context unsafe.Pointer, messageOffset int32, messageLength int32) {
	...
	gasToUse := metering.GasSchedule().ReshuskAPICost.SignalError
	metering.UseGas(gasToUse)
}
...
func getExternalBalance(context unsafe.Pointer, addressOffset int32, resultOffset int32) {
	...
	gasToUse := metering.GasSchedule().ReshuskAPICost.GetExternalBalance
	metering.UseGas(gasToUse)
}
...
func blockHash(context unsafe.Pointer, nonce int64, resultOffset int32) int32 {
	...
	gasToUse := metering.GasSchedule().ReshuskAPICost.GetBlockHash
	metering.UseGas(gasToUse)
...
func transferValue(context unsafe.Pointer, destOffset int32, valueOffset int32, dataOffset int32, length int32) int32 {
	...
	gasToUse := metering.GasSchedule().ReshuskAPICost.TransferValue
...
func asyncCall(context unsafe.Pointer, destOffset int32, valueOffset int32, dataOffset int32, length int32) {
	...
	gasToUse := gasSchedule.ReshuskAPICost.AsyncCallStep
	gasToUse += gasSchedule.BaseOperationCost.DataCopyPerByte * uint64(length)
	metering.UseGas(gasToUse)

	gasLimit := metering.GasLeft()

	minAsyncCallCost := 2*gasSchedule.ReshuskAPICost.AsyncCallStep + gasSchedule.ReshuskAPICost.AsyncCallbackGasLock
...
func getArgumentLength(context unsafe.Pointer, id int32) int32 {
	...
	gasToUse := metering.GasSchedule().ReshuskAPICost.GetArgument
	metering.UseGas(gasToUse)
...
func getFunction(context unsafe.Pointer, functionOffset int32) int32 {
	...
	gasToUse := metering.GasSchedule().ReshuskAPICost.GetFunction
	metering.UseGas(gasToUse)
...
func getNumArguments(context unsafe.Pointer) int32 {
	...
	gasToUse := metering.GasSchedule().ReshuskAPICost.GetNumArguments
	metering.UseGas(gasToUse)
...
func storageStore(context unsafe.Pointer, keyOffset int32, keyLength int32, dataOffset int32, dataLength int32) int32 {
	...
	gasToUse := metering.GasSchedule().ReshuskAPICost.StorageStore
	metering.UseGas(gasToUse)
...
func storageLoadLength(context unsafe.Pointer, keyOffset int32, keyLength int32) int32 {
	...
	gasToUse := metering.GasSchedule().ReshuskAPICost.StorageLoad
	metering.UseGas(gasToUse)
...
func setStorageLock(context unsafe.Pointer, keyOffset int32, keyLength int32, lockTimestamp int64) int32 {
	...
	gasToUse := metering.GasSchedule().ReshuskAPICost.Int64StorageStore
	metering.UseGas(gasToUse)
...
func getCaller(context unsafe.Pointer, resultOffset int32) {
	...
	gasToUse := metering.GasSchedule().ReshuskAPICost.GetCaller
	metering.UseGas(gasToUse)
}
...
func callValue(context unsafe.Pointer, resultOffset int32) int32 {
	...
	gasToUse := metering.GasSchedule().ReshuskAPICost.GetCallValue
	metering.UseGas(gasToUse)
...
func writeLog(context unsafe.Pointer, pointer int32, length int32, topicPtr int32, numTopics int32) {
	...
	gasToUse := metering.GasSchedule().ReshuskAPICost.Log
...
func getBlockTimestamp(context unsafe.Pointer) int64 {
	...
	gasToUse := metering.GasSchedule().ReshuskAPICost.GetBlockTimeStamp
	metering.UseGas(gasToUse)
...
func getBlockNonce(context unsafe.Pointer) int64 {
	...
	gasToUse := metering.GasSchedule().ReshuskAPICost.GetBlockNonce
	metering.UseGas(gasToUse)
...
func getBlockRound(context unsafe.Pointer) int64 {
	...
	gasToUse := metering.GasSchedule().ReshuskAPICost.GetBlockRound
	metering.UseGas(gasToUse)
...
func getBlockEpoch(context unsafe.Pointer) int64 {
	...
	gasToUse := metering.GasSchedule().ReshuskAPICost.GetBlockEpoch
	metering.UseGas(gasToUse)
...
func getBlockRandomSeed(context unsafe.Pointer, pointer int32) {
	...
	gasToUse := metering.GasSchedule().ReshuskAPICost.GetBlockRandomSeed
	metering.UseGas(gasToUse)

	randomSeed := blockchain.CurrentRandomSeed()
	err := runtime.MemStore(pointer, randomSeed)
	arwen.WithFault(err, context, runtime.ReshuskAPIErrorShouldFailExecution())
}
...
func getStateRootHash(context unsafe.Pointer, pointer int32) {
	...
	gasToUse := metering.GasSchedule().ReshuskAPICost.GetStateRootHash
	metering.UseGas(gasToUse)
...
func returnData(context unsafe.Pointer, pointer int32, length int32) {
	...
	output.Finish(data)
	gasToUse := metering.GasSchedule().ReshuskAPICost.Finish
	gasToUse += metering.GasSchedule().BaseOperationCost.PersistPerByte * uint64(length)
	metering.UseGas(gasToUse)
}
...
func int64getArgument(context unsafe.Pointer, id int32) int64 {
	...
	gasToUse := metering.GasSchedule().ReshuskAPICost.Int64GetArgument
	metering.UseGas(gasToUse)

	args := runtime.Arguments()
	if id < 0 || id >= int32(len(args)) {
		arwen.WithFault(arwen.ErrArgIndexOutOfRange, context, runtime.ReshuskAPIErrorShouldFailExecution())
		return 0
	}
	...
	if !argBigInt.IsInt64() {
		arwen.WithFault(arwen.ErrArgOutOfRange, context, runtime.ReshuskAPIErrorShouldFailExecution())
		return 0
	}
...
func int64storageLoad(context unsafe.Pointer, keyOffset int32, keyLength int32) int64 {
	...
	gasToUse := metering.GasSchedule().ReshuskAPICost.Int64StorageLoad
	metering.UseGas(gasToUse)
...
func int64finish(context unsafe.Pointer, value int64) {
	...
	gasToUse := metering.GasSchedule().ReshuskAPICost.Int64Finish
	metering.UseGas(gasToUse)
}
...
func executeOnSameContext(
	...
	gasToUse := metering.GasSchedule().ReshuskAPICost.ExecuteOnSameContext
...
func executeOnDestContext(
	...
	gasToUse := metering.GasSchedule().ReshuskAPICost.ExecuteOnDestContext
	gasToUse += metering.GasSchedule().BaseOperationCost.DataCopyPerByte * uint64(actualLen)
	metering.UseGas(gasToUse)
...
func delegateExecution(
	...
	gasToUse := metering.GasSchedule().ReshuskAPICost.DelegateExecution
	gasToUse += metering.GasSchedule().BaseOperationCost.DataCopyPerByte * uint64(actualLen)
	metering.UseGas(gasToUse)
...
func executeReadOnly(
	...
	gasToUse := metering.GasSchedule().ReshuskAPICost.ExecuteReadOnly
	gasToUse += metering.GasSchedule().BaseOperationCost.DataCopyPerByte * uint64(actualLen)
	metering.UseGas(gasToUse)
...
func createContract(
	...
	gasToUse := metering.GasSchedule().ReshuskAPICost.CreateContract
	gasToUse += metering.GasSchedule().BaseOperationCost.DataCopyPerByte * uint64(actualLen)
	metering.UseGas(gasToUse)
	gasLimit := metering.GasLeft()
...
func getNumReturnData(context unsafe.Pointer) int32 {
	...
	gasToUse := metering.GasSchedule().ReshuskAPICost.GetNumReturnData
	metering.UseGas(gasToUse)
...
func getReturnDataSize(context unsafe.Pointer, resultID int32) int32 {
	...
	gasToUse := metering.GasSchedule().ReshuskAPICost.GetReturnDataSize
	metering.UseGas(gasToUse)
...
func getReturnData(context unsafe.Pointer, resultID int32, dataOffset int32) int32 {
	...
	gasToUse := metering.GasSchedule().ReshuskAPICost.GetReturnData
	metering.UseGas(gasToUse)
...
func getOriginalTxHash(context unsafe.Pointer, dataOffset int32) {
	...
	_ = arwen.WithFault(err, context, runtime.ReshuskAPIErrorShouldFailExecution())
}

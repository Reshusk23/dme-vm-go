...
import (
	...
	"github.com/Reshusk23/dme-vm-common/parsers"
	"github.com/Reshusk23/dme-vm/arwen"
	"github.com/Reshusk23/dme-vm/math"
...
func (host *vmHost) createDestinationContractCallInput(asyncCallInfo arwen.AsyncCallInfoHandler) (*vmcommon.ContractCallInput, error) {
	...
	gasToUse := host.Metering().GasSchedule().ReshuskAPICost.AsyncCallStep
...
func (host *vmHost) createCallbackContractCallInput(
	...
	gasToUse := metering.GasSchedule().ReshuskAPICost.AsyncCallStep

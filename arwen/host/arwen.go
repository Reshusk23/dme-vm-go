...
import (
	...
	"github.com/Reshusk23/dme-vm/arwen/contexts"
	"github.com/Reshusk23/dme-vm/arwen/crypto"
	"github.com/Reshusk23/dme-vm/arwen/ethapi"
	"github.com/Reshusk23/dme-vm/arwen/reshuskapi"
...
func NewArwenVM(
	...
	imports, err := reshuskapi.ReshuskEIImports()
	if err != nil {
		return nil, err
	}

	imports, err = reshuskapi.BigIntImports(imports)
	if err != nil {
		return nil, err
	}
	...
	host.storageContext, err = contexts.NewStorageContext(host, blockChainHook, hostParameters.ReshuskProtectedKeyPrefix)
	if err != nil {
		return nil, err
	}

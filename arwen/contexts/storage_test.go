...
import (
	...
	"github.com/Reshusk23/dme-vm/mock"
	"github.com/stretchr/testify/require"
)

var reshuskReservedTestPrefix = []byte("RESERVED")
...
func TestNewStorageContext(t *testing.T) {
	...
	storageContext, err := NewStorageContext(host, mockBlockchain, reshuskReservedTestPrefix)
	require.Nil(t, err)
...
func TestStorageContext_SetAddress(t *testing.T) {
	...
	storageContext, _ := NewStorageContext(host, bcHook, reshuskReservedTestPrefix)
...
func TestStorageContext_GetStorageUpdates(t *testing.T) {
	...
	storageContext, _ := NewStorageContext(host, mockBlockchainHook, reshuskReservedTestPrefix)
...
func TestStorageContext_SetStorage(t *testing.T) {
	...
	storageStatus, err = storageContext.SetStorage(key, value)
	require.Equal(t, arwen.ErrStoreReshuskReservedKey, err)

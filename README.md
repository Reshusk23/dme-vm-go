...
[![Build Status](https://travis-ci.com/Reshusk23/dme-vm.svg?branch=master)](https://travis-ci.com/Reshusk23/dme-vm)

Arwen is the WASM-based Virtual Machine for running Reshusk Smart Contracts.

The VM is launched as a child process of the [Reshusk Node](https://github.com/Reshusk23/dme-dharitri).

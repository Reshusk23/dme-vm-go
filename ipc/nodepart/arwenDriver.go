...
import (
	...
	"github.com/Reshusk23/dme-vm/ipc/marshaling"
)
...
// GasScheduleChange implements vmcommon.VMExecutionHandler.
func (*ArwenDriver) GasScheduleChange(newGasSchedule map[string]map[string]uint64) {
	panic("unimplemented")
}

// GetVersion implements vmcommon.VMExecutionHandler.
func (*ArwenDriver) GetVersion() string {
	panic("unimplemented")
}

// IsInterfaceNil implements vmcommon.VMExecutionHandler.
func (*ArwenDriver) IsInterfaceNil() bool {
	panic("unimplemented")
}

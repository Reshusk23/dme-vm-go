...
import (
	...
	"github.com/Reshusk23/dme-vm/ipc/common"
)
...
func (*BlockchainHookGateway) GetCode(vmcommon.UserAccountHandler) []byte {
	panic("unimplemented")
}

// GetCompiledCode implements vmcommon.BlockchainHook.
func (*BlockchainHookGateway) GetCompiledCode(codeHash []byte) (bool, []byte) {
	panic("unimplemented")
}

// GetDCTToken implements vmcommon.BlockchainHook.
func (*BlockchainHookGateway) GetDCTToken(address []byte, tokenID []byte, nonce uint64) (*dct.DCToken, error) {
	panic("unimplemented")
}

// GetSnapshot implements vmcommon.BlockchainHook.
func (*BlockchainHookGateway) GetSnapshot() int {
	panic("unimplemented")
}

// IsInterfaceNil implements vmcommon.BlockchainHook.
func (*BlockchainHookGateway) IsInterfaceNil() bool {
	panic("unimplemented")
}

// IsPayable implements vmcommon.BlockchainHook.
func (*BlockchainHookGateway) IsPayable(address []byte) (bool, error) {
	panic("unimplemented")
}

// RevertToSnapshot implements vmcommon.BlockchainHook.
func (*BlockchainHookGateway) RevertToSnapshot(snapshot int) error {
	panic("unimplemented")
}

// SaveCompiledCode implements vmcommon.BlockchainHook.
func (*BlockchainHookGateway) SaveCompiledCode(codeHash []byte, code []byte) {
	panic("unimplemented")
}
